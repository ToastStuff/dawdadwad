...
function VulcanLIB.NewButton(buttonText)
    ...
    -- Position the button below the separator with slight spacing (55px down from the separator)
    Button.Position = UDim2.new(0, 10, 0, 55)  -- X=10, Y=45 for small spacing from separator
