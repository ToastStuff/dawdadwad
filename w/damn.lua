...
function VulcanLIB.NewButton(buttonText)
    ...
    Button.TextSize = 22
    Button.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White text for better contrast
    Button.BackgroundColor3 = Color3.fromRGB(128, 0, 0)  -- Maroon button
    Button.Size = UDim2.new(0, 120, 0,  35)  -- Width: 120px, Height: 35px
    Button.Position = UDim2.new(0.5, -60, 0, 100)  -- Positioned more centrally in the frame
